...
from swarm_rescue.maps.walls_02 import add_walls, add_boxes


class Map02(MapAbstract):
    ...
    def __init__(
        ...
        self._max_walltime_limit = 180  # In seconds

        # PARAMETERS MAP
        self._size_area = (1200, 900)

        # 无人机出生区域中心点
        self._start_area_drones = (14, -277)

        self._disposal_center = DisposalCenter(size=(168, 85))
        self._disposal_center_pos = ((13, -402), 0)
...
def main():
    eval_plan = EvalPlan()
    eval_config = EvalConfig(map_name="Map02", zones_config=())
