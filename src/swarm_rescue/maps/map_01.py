...
from swarm_rescue.maps.walls_01 import add_walls, add_boxes


class Map01(MapAbstract):
    ...
    def __init__(
        ...
        self._max_walltime_limit = 90  # In seconds

        # PARAMETERS MAP
        self._size_area = (1250, 800)

        # 无人机出生区域中心点
        self._start_area_drones = (-505, 98)

        self._disposal_center = DisposalCenter(size=(226, 183))
        self._disposal_center_pos = ((-505, 302), 0)
...
def main():
    eval_plan = EvalPlan()
    eval_config = EvalConfig(map_name="Map01", zones_config=())
