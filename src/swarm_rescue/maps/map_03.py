...
from swarm_rescue.maps.walls_03 import add_walls, add_boxes


class Map03(MapAbstract):
    ...
    def __init__(
        ...
        # 无人机出生区域中心点
        self._start_area_drones = (-20, 93)

        self._disposal_center = DisposalCenter(size=(211, 111))
        self._disposal_center_pos = ((-20, -47), 0)
...
def main():
    eval_plan = EvalPlan()
    eval_config = EvalConfig(map_name="Map03", zones_config=())
