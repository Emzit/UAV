...
from swarm_rescue.maps.walls_04 import add_walls, add_boxes


class Map04(MapAbstract):
    ...
    def __init__(
        ...
        # 无人机出生区域中心点
        self._start_area_drones = (-232, -463)

        self._disposal_center = DisposalCenter(size=(246, 152))
        self._disposal_center_pos = ((13, -472), 0)
