...
LINEAR_SPEED_RATIO_BOMB: float = 1.0
...
# Scale factor for headless video capture (0.5 = half resolution). Reduces FBO
# readback and encoder cost; full simulation rendering is unchanged.
VIDEO_RECORDING_SCALE: float = 0.5
