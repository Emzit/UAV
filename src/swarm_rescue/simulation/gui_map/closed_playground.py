...
from swarm_rescue.simulation.elements.disposal_center import bomb_disposal_center_collision
...
from swarm_rescue.simulation.gui_map.collision_handlers import (
    drone_collision_bomb_ignore_place,
    grasper_grasps_bomb,
)
...
class ClosedPlayground(Playground):
    ...
    def _handle_interactions(self) -> None:
        ...
        self.add_interaction(CollisionTypes.BOMB,
                             CollisionTypes.DISPOSAL_CENTER,
                             bomb_disposal_center_collision)
        ...
        # Red team placement: ignore DRONE <-> BOMB physical collisions for
        # bombs produced by the placer, so they stay at the intended position.
        self.add_interaction(CollisionTypes.DRONE,
                             CollisionTypes.BOMB,
                             drone_collision_bomb_ignore_place)
