...
class DataSaver:
    ...
    def save_one_round(self,
        ...
        Args:
            ...
            percent_disposed (float): Percentage of disposed bombs.
            ...
            full_disposal_timestep (int): Timestep when all disposed.
