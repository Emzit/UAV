...
class MapWithOpeningDoors(MapAbstract):
    ...
    doors disappear at regular intervals, allowing drones to access new areas with bombs.
    ...
    def __init__(self, drone_type: Type[DroneAbstract], zones_config=()):
        ...
        # Create disposal center and return area
        self._disposal_center = DisposalCenter(size=(80, 60))
        self._disposal_center_pos = ((0, 0), 0)
        self._playground.add(self._disposal_center, self._disposal_center_pos)

        # Add bombs in areas that become accessible when doors open
        self._bombs_pos = [
...
def main():
    ...
    progressively to allow drones to access new areas and rescue bombs.
    The mission is complete when all 4 bombs are brought to the disposal center.
    """
    ...
    print("Mission: Navigate through opening doors to dispose 4 bombs!")
    print()
