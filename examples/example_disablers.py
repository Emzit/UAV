...
from swarm_rescue.simulation.elements.sensor_disablers import (NoGpsZone, NoComZone,
                                                               KillZone)
...
class MyMapDisablers(MapAbstract):
    ...
    def __init__(self, drone_type: Type[DroneAbstract]):
        ...
        self._disposal_center_pos = ((0, 100), 0)
...
def main():
    the_map = MyMapDisablers(drone_type=MyDroneDisablers)
