...
class MyDroneMovingBomb(DroneAbstract):
...
class MyMapMovingBomb(MapAbstract):
    ...
    def __init__(self, drone_type: Type[DroneAbstract]):
        ...
        self._disposal_center_pos = ((0, 250), 0)

        self._bombs_pos = [(200, 0), (-200, 0), (-200, -200), (150, -200)]
        self._bombs_path = [[(250, 0), (250, 100)],
                                      [(-250, 0)],
                                      [],
...
def main():
    the_map = MyMapMovingBomb(drone_type=MyDroneMovingBomb)
    ...
    if video_capture_enabled:
        ...
        filename_video_capture = rpc.path + "/example_moving_bomb.avi"
    else:
